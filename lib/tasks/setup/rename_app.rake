...
namespace :setup do
  ...
  task rename_app: :environment do
    ...
    replace_patterns = [
      [/\bHybrid Template\b/, new_title], # Title Case
      [/\bHybridTemplate\b/,  new_camel], # CamelCase
      [/\bhybrid_template\b/, new_snake], # snake_case (strict)
      [/hybrid_template/,     new_snake] # snake_case (loose)
    ]
